...
let svg = `<?xml version="1.0" encoding="UTF-8"?> <svg xmlns="http://www.w3.org/2000/svg" width="1400" height="1000" viewBox="0 0 1400 1000"> <rect width="1400" height="1000" fill="#f3f4f6"/> <rect x="0" y="0" width="1400" height="120" fill="#111827"/> <text x="60" y="72" font-size="42" font-weight="700" fill="#ffffff" font-family="Arial, Helvetica, sans-serif">Call Evidence</text> <text x="60" y="103" font-size="22" fill="#ffffff" font-family="Arial, Helvetica, sans-serif">Automatically generated from Bland webhook data</text> <rect x="50" y="150" width="1300" height="780" rx="10" fill="#ffffff" stroke="#d1d5db" stroke-width="2"/> `;
...
1. Resolve the issue — get permission, gate code, confirmed address, or schedule a specific date and time (Mon–Sat, 8 AM–5 PM).
1. Be helpful and answer any questions they have.
...
const body = JSON.stringify({
  phone_number:        formatPhoneE164(phone),
  task,
  model:               'enhanced',
  language:            'en-US',
  voice:               'nat',
